  ...
  return (
    <RootStyle {...other}>
      <Box sx={{ position: 'absolute', right: 18, bottom: 28, zIndex: 8 }}>
        <Image
          alt="teacher"
          src="/static/images/course/course_teacher_hero.png"
      ...
      >
        <Image alt="book icon" src="/static/icons/ic_book.png" sx={{ width: 52, height: 62 }} />
      </Box>
      ...
      >
        <Image alt="pencil icon" src="/static/icons/ic_pencil.png" sx={{ width: 60, height: 77 }} />
      </Box>
