...
const CORE_VALUES = [
  {
    ...
    icon: '/static/icons/ic_statistics.svg',
  },
  {
    title: 'Social Media Strategy',
    description: 'Suspendisse enim turpis, dictum sed, iaculis a, condimentum nec, nisi. ',
    icon: '/static/icons/ic_social_media.svg',
  },
  {
    title: 'Real Time and Data',
    description: 'Suspendisse enim turpis, dictum sed, iaculis a, condimentum nec, nisi. ',
    icon: '/static/icons/ic_real_time.svg',
  },
  {
    title: 'Online Media Management',
    description: 'Suspendisse enim turpis, dictum sed, iaculis a, condimentum nec, nisi. ',
    icon: '/static/icons/ic_checklist.svg',
  },
  {
    title: 'Reporting & Analysis',
    description: 'Suspendisse enim turpis, dictum sed, iaculis a, condimentum nec, nisi. ',
    icon: '/static/icons/ic_report.svg',
  },
  {
