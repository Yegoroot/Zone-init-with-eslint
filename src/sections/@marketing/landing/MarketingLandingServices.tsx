...
const SERVICES = [
  {
    name: 'SEO',
    icon: '/static/icons/service/ic_service_seo.svg',
    text: 'Nunc nonummy metus. Donec elit libero',
    path: Routes.marketing.services,
  },
  {
    name: 'Email Marketing',
    icon: '/static/icons/service/ic_service_mail.svg',
    text: 'Nunc nonummy metus. Donec elit libero',
    path: Routes.marketing.services,
  },
  {
    name: 'Search Engine Oprimization',
    icon: '/static/icons/service/ic_service_analysis.svg',
    text: 'Nunc nonummy metus. Donec elit libero',
    path: Routes.marketing.services,
  },
  {
    name: 'Social Marketing',
    icon: '/static/icons/service/ic_service_bullhorn.svg',
    text: 'Nunc nonummy metus. Donec elit libero',
    path: Routes.marketing.services,
  },
];
