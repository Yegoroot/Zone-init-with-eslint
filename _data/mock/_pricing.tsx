...
export const _pricingHome = [
  {
    license: 'Standard',
    price: '69',
    icons: ['/static/icons/platform/ic_platform_javascript.svg'],
  ...
  },
  {
    ...
    price: '129',
    icons: [
      '/static/icons/platform/ic_platform_javascript.svg',
      '/static/icons/platform/ic_platform_typescript.svg',
      '/static/icons/platform/ic_platform_figma.svg',
    ],
    commons: ['One end products', '12 months updates', '6 months of support'],
    options: [
      { title: 'JavaScript version', disabled: false },
...
export const _pricingMarketing = [
  {
    license: 'Basic',
    price: '29',
    icon: '/static/icons/pricing/ic_plan_basic03.svg',
  ...
  },
  {
    license: 'Starter',
    price: '59',
    icon: '/static/icons/pricing/ic_plan_starter03.svg',
  ...
  },
  {
    license: 'Premium',
    price: '99',
    icon: '/static/icons/pricing/ic_plan_premium03.svg',
...
export const _pricing01 = [
  {
    license: 'Basic',
    price: 'Free',
    icon: '/static/icons/pricing/ic_plan_basic01.svg',
    options: [
  ...
  },
  {
    license: 'Starter',
    price: '4.99',
    icon: '/static/icons/pricing/ic_plan_starter01.svg',
    options: [
      { title: '3 prototypes', disabled: false },
      { title: '3 boards', disabled: false },
  ...
  },
  {
    license: 'Premium',
    price: '9.99',
    icon: '/static/icons/pricing/ic_plan_premium01.svg',
    options: [
      { title: '3 prototypes', disabled: false },
      { title: '3 boards', disabled: false },
      { title: 'Up to 5 team members', disabled: false },
...
export const _pricing02 = [
  {
    ...
    price: 'Free',
    icon: '/static/icons/pricing/ic_plan_basic02.svg',
    options: [
  ...
  },
  {
    ...
    price: '4.99',
    icon: '/static/icons/pricing/ic_plan_starter02.svg',
    options: [
      { title: '3 prototypes', tootip: '3 prototypes', disabled: false },
      { title: '3 boards', tootip: '3 boards', disabled: false },
  ...
  },
  {
    ...
    price: '9.99',
    icon: '/static/icons/pricing/ic_plan_premium02.svg',
    options: [
      { title: '3 prototypes', tootip: '3 prototypes', disabled: false },
      { title: '3 boards', tootip: '3 boards', disabled: false },
      { title: 'Up to 5 team members', tootip: 'Up to 5 team members', disabled: false },
