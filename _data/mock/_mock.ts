...
const _mock = {
  ...
  image: {
    avatar: (index: number) => `/static/mocks/avatar/avatar_${index + 1}.jpg`,
    company: (index: number) => `/static/mocks/company/company_${index + 1}.png`,
    marketing: (index: number) => `/static/mocks/marketing/marketing_${index + 1}.jpg`,
    //
    travel: (index: number) => `/static/mocks/travel/travel_${index + 1}.jpg`,
    travelLarge: (index: number) => `/static/mocks/travel/travel_hero_${index + 1}.jpg`,
    //
    career: (index: number) => `/static/mocks/career/career_${index + 1}.jpg`,
    course: (index: number) => `/static/mocks/e-learning/course_${index + 1}.jpg`,
  },
  video,
  countries,
  jobTitle,
